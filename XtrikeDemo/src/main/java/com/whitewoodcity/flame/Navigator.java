...
public class Navigator extends HashMap<String, Constructor> {
  ...
  public static void pushNamed(String paneName, Map<Object, Object> parameters) {
    push(MainInterface.getRoutes().get(paneName).build(parameters));
  }

  public static void pushNamed(String paneName, Map<Object, Object> parameters, Runnable setOnFinished) {
    pushNamed(paneName, parameters);
    setOnFinished.run();
  }

  public static void pushNamed(Runnable setOnStarted, String paneName, Map<Object, Object> parameters) {
    setOnStarted.run();
    pushNamed(paneName, parameters);
  }
  ...
  public static void replaceNamed(String paneName, Map<Object, Object> parameters, Runnable setOnFinished) {
    replaceNamed(paneName, parameters);
    setOnFinished.run();
  }

  public static void replaceNamed(Runnable setOnStarted, String paneName, Map<Object, Object> parameters) {
    setOnStarted.run();
    replaceNamed(paneName, parameters);
  }

  public static void replaceNamed(String paneName, Map<Object, Object> parameters) {
  ...
  public static void pop(Map<Object, Object> parameters) {
    var root = MainInterface.getRoot();
  ...
  public static void pop(Map<Object, Object> parameters, Runnable setOnFinished) {
    var root = MainInterface.getRoot();
    if (root.getChildren().size() > 1) {
      var node = (PushAndPop) root.getChildren().get(root.getChildren().size() - 1);
      node.disable();
